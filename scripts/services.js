...
serviceObject.onload = function() {
    ...
    document.getElementById("other1").innerHTML = serviceInfo.Services["1"].additional
    ...
    document.getElementById("other2").innerHTML = serviceInfo.Services["2"].additional
    ...
    document.getElementById("other3").innerHTML = serviceInfo.Services["3"].additional
    ...
    document.getElementById("other4").innerHTML = serviceInfo.Services["4"].additional
